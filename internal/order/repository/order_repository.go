...
type OrderRepository interface {
	...
	Create(ctx context.Context, tx *transaction.Handle, order *model.Order) error
	...
	GetByNoInTx(ctx context.Context, tx *transaction.Handle, orderNo string) (*model.Order, error)
	...
	Cancel(ctx context.Context, tx *transaction.Handle, orderNo string) (bool, error)
	...
	ConfirmReceipt(ctx context.Context, orderNo string) (bool, error)
}

// OrderItemRepository 订单项数据访问接口。
type OrderItemRepository interface {
	// Create 事务内创建订单项。
	Create(ctx context.Context, tx *transaction.Handle, item *model.OrderItem) error
